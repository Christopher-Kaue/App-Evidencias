-- Import em provedores MySQL na nuvem (Railway, Aiven, RDS, etc.)
-- que ja atribuem um banco: na UI do provedor, selecione o banco e importe este arquivo.
-- Nao contem CREATE DATABASE (muitos paineis nao permitem).
...
-- Senhas de teste: texto plano "Senha123" (bcrypt). Login web aceita apenas professor/coordenador.
