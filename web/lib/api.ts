 ...
 * 2) localhost → XAMPP (README)
 * 3) Producao Vercel: `https://<slug>.vercel.app` → `https://<slug>-api.vercel.app`
 * 4) Preview (`-git-` no slug) ou outros: "" — defina NEXT_PUBLIC_API_BASE_URL
 */
